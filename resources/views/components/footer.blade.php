            ...
            <div class="row gy-3 gy-md-5 gy-xl-0 align-items-sm-center">
                <div class="col-xs-12 col-sm-6 col-xl-3 order-0 order-xl-0">
                    <div class="footer-logo-wrapper text-center text-sm-start">
                        <a href="#!">
                            <img src="{{ asset('assets/img/bearblue.svg') }}" class="img-fluid" width="50px" alt="Logo de Enfríatech">
                        </a>
                    </div>
                </div>
                ...
                <ul class="nav justify-content-center">
                    ...
                    <li class="nav-item">
                        <a class="nav-link link-secondary px-2 px-md-3" href="{{ url('cotizacion.html') }}">Cotizar</a>
                    </li>
                </ul>
            </div>
